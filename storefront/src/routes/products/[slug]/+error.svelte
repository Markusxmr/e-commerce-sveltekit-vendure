<script>
  import PhotographIcon from '$lib/components/icons/photograph.svelte'
</script>
  ...
  >
    <div class="w-full max-w-2xl mx-auto sm:block lg:max-w-none">
      <span class="rounded-md overflow-hidden">
        <div
          class="w-full h-96 bg-slate-200 rounded-lg flex content-center justify-center"
        >
          <PhotographIcon class="w-48 text-white" />
        </div>
      </span>
    </div>
